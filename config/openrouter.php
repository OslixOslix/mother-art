...
return [
    ...
    'naming' => [
        'model' => env('OPENROUTER_NAMING_MODEL', 'google/gemini-3.1-flash-image'),
        'prompt' => 'дай название этой картине и придумай небольшое четверостишие, которое ей соответсвует. если настроение на картине грустное - четверостишие печальное, сложное, метафоричное, в стиле серебрянного века. Если настроение картины веселое - то просто метафоричное и сложное, но не грустное. Стихотворение не должно описывать картину буквально. Оно должно подходить по настроению и метафоре. Четверостишие передай массивом quatrain из ровно четырёх строк — каждая строка стиха отдельным элементом.',
        'json_schema' => [
            ...
            'schema' => [
                ...
                'properties' => [
                    ...
                    'slug' => [
                        'type' => 'string',
                        'description' => 'URL-slug из названия, латиница, через дефис',
                    ],
                    'quatrain' => [
                        'type' => 'array',
                        'description' => 'Четверостишие: ровно четыре строки, каждая строка — отдельный элемент массива',
                        'items' => [
                            'type' => 'string',
                        ],
                        'minItems' => 4,
