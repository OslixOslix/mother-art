...
return [
    ...
    'import' => [
        'prompt' => 'Обработай эту картину или керамическую поделку: изолируй объект, помести на чистый белый фон, профессиональное студийное освещение, без теней на фоне, объект по центру кадра. Результат должен быть идеален для карточки товара интернет-магазина. Сохрани точные цвета и детали произведения.',
        'modalities' => ['image'],
